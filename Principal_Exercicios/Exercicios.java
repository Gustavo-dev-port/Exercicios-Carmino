...
public class Exercicios {
    ...
    public void verificarAnoBissexto() {
        try (Scanner datScanner = new Scanner(System.in)) {
        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            switch (opcao) {
                case 1 -> {
                    ...
                    switch (opcaoSuporte) {
                        case 1 -> System.out.println("Você escolheu Internet Fixa.");
                        case 2 -> System.out.println("Você escolheu Celular.");
                        case 3 -> System.out.println("Você escolheu Telefone Fixo.");
                ...
                case 2 -> {
                    ...
                    switch (opcaoFinanceiro) {
                        case 1 -> System.out.println("Você escolheu Conta a Pagar.");
                        case 2 -> System.out.println("Você escolheu Conta a Receber.");
                        case 3 -> System.out.println("Você escolheu Extrato.");
                        case 4 -> System.out.println("Voltando ao menu principal...");
                        default -> System.out.println("Opção inválida. Tente Novamente");
                    }
                }
